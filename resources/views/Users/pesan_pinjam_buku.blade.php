...
@section('title', 'Kirim Pesan Ke Admin - D Perpus')
	...
	<div class="row">
		...
		<div class="col-md-9">
			<div class="card shadow card-primary card-outline">
            	...
            	<form class="form-group" action="/buku/send-pesan-peminjaman" method="post">
            		@csrf	
            		<div class="card-body row">
            			...
            			<div class="col-12 mb-3 row">
            				...
            				<div class="col-10">
            					<select class="form-control select2bs4 disabled" style="width: 100%;" name="penerima">
            						<option>admin</option>
				                  </select>
            				</div>
            			...
            			<div class="col-12 mb-3">
            				<input type="text" class="form-control " name="judul_pesan" value="Peminjaman">
            			</div>
            			<div class="col-12 mb-2">
            				<textarea id="compose-textareas" class="form-control" style="height: 300px" name="isi_pesan">
                                @php $date = date('Y-m-d'); @endphp
                                <h1 class="mb-3">Judul : {{ $data_buku->judul_buku }}</h1>
                                <h4 class="mb-3">Pengarang :{{ $data_buku->pengarang }}</h4>
                                <h4 class="mb-3">Penerbit :{{ $data_buku->penerbit_buku }}</h4>
                                <h4 class="mb-3">Kategori :{{ $data_buku->kategori_buku }}</h4>
