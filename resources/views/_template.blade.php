    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/">
                ...
                <div class="sidebar-brand-text mx-3">D-Perpus</div>
            </a>
            ...
            @if(auth()->user()->role == 'admin')
                <li class="nav-item">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="/data-peminjam">Peminjaman Buku</a>
                            <a class="collapse-item" href="cards.html">History Peminjaman</a>
                        </div>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            <a class="collapse-item" href="/buku">Data Buku</a>
                            <a class="collapse-item" href="/data/kategori">Data Kategori Buku</a>
                            <a class="collapse-item" href="/data/penerbit">Data Penerbit Buku</a>
                        </div>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="/inbox">Terbaru</a>
                        </div>
                    </div>
                </li>
                 ...
                 <li class="nav-item">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="buttons.html">Umum</a>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="utilities-color.html">Tanggal pengembalian</a>
                            <a class="collapse-item" href="utilities-border.html">History pengembalian</a>
            ...
            <div class="sidebar-card d-none d-lg-flex">
                <img class="sidebar-card-illustration mb-2" src="/startbootstrap-sb-admin-2-gh-pages/img/undraw_rocket.svg" alt="...">
                <p class="text-center mb-2"><strong>D-Perpus a Libary</strong> you can borrow a book.</p>
            </div>
